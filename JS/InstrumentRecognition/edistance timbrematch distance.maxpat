...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 924.0, 485.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 843.0, 546.0, 252.0, 174.0 ],
					"presentation_rect" : [ 846.75, 546.0, 0.0, 0.0 ],
					"setminmax" : [ 0.0, 300.0 ],
					"setstyle" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 843.0, 515.0, 100.0, 20.0 ],
					"text" : "onepole 0.9"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 592.0, 564.0, 99.0 ],
					"setminmax" : [ 0.0, 30.0 ],
					"setstyle" : 1,
					"size" : 250,
					"slidercolor" : [ 1.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.0, 114.5, 56.0, 18.0 ],
					"presentation_rect" : [ 806.0, 123.0, 0.0, 0.0 ],
					"text" : "getInprof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 738.0, 233.0, 100.0, 20.0 ],
					"text" : "zl group 250"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 611.75, 230.0, 70.0, 20.0 ],
					"varname" : "number[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1019.0, 515.0, 100.0, 20.0 ],
					"text" : "s groupsize"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1019.0, 485.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.0, 140.0, 56.0, 18.0 ],
					"text" : "getSprof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 475.5, 564.0, 99.0 ],
					"setminmax" : [ 0.0, 30.0 ],
					"setstyle" : 1,
					"size" : 250,
					"slidercolor" : [ 1.0, 0.0, 0.0, 1.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 26.0, 82.0, 47.0, 20.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 54.0, 115.5, 77.0, 20.0 ],
									"text" : "counter 1 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 92.666664, 147.5, 32.5, 20.0 ],
									"text" : "- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 26.0, 52.0, 47.0, 20.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 54.0, 16.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 187.5, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 92.666664, 187.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 582.75, 136.0, 47.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 17.0, 365.0, 51.5, 55.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 750.75, 29.0, 147.0, 84.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 751.0, 165.0, 123.0, 52.0 ],
					"setminmax" : [ 0.0, 25.0 ],
					"size" : 25,
					"spacing" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1120.0, 25.5, 147.0, 84.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1122.0, 164.0, 123.0, 52.0 ],
					"setminmax" : [ 0.0, 25.0 ],
					"size" : 25,
					"spacing" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1018.75, 50.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 909.75, 290.0, 252.0, 174.0 ],
					"setminmax" : [ 0.0, 300.0 ],
					"setstyle" : 3,
					"slidercolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"thickness" : 20,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 909.75, 255.0, 48.0, 20.0 ],
					"text" : "!- 500"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1016.5, 107.0, 20.0, 20.0 ],
					"varname" : "toggle[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1016.5, 136.0, 47.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 965.75, 255.0, 70.0, 20.0 ],
					"varname" : "number[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1016.5, 165.0, 105.0, 20.0 ],
					"text" : "prepend compare"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 909.75, 165.0, 100.0, 20.0 ],
					"text" : "prepend train"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 909.75, 107.0, 20.0, 20.0 ],
					"varname" : "toggle[5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 909.75, 136.0, 47.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 937.75, 78.0, 100.0, 20.0 ],
					"text" : "speedlim 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 909.75, 208.0, 118.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "distanceMetrics.js",
						"parameter_enable" : 0
					}
,
					"text" : "js distanceMetrics.js",
					"varname" : "js[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 938.0, 25.5, 182.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 691.75, 50.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 582.75, 290.0, 252.0, 174.0 ],
					"setminmax" : [ 0.0, 300.0 ],
					"setstyle" : 3,
					"slidercolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"thickness" : 20,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 582.75, 255.0, 48.0, 20.0 ],
					"text" : "!- 600"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 689.5, 107.0, 20.0, 20.0 ],
					"varname" : "toggle[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.5, 136.0, 47.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 638.75, 255.0, 70.0, 20.0 ],
					"varname" : "number[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.5, 177.0, 105.0, 20.0 ],
					"text" : "prepend compare"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.75, 177.0, 100.0, 20.0 ],
					"text" : "prepend learn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.0, 183.5, 77.0, 18.0 ],
					"text" : "clearSprof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.0, 161.0, 83.0, 18.0 ],
					"text" : "clearInprof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 582.75, 107.0, 20.0, 20.0 ],
					"varname" : "toggle[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.75, 78.0, 100.0, 20.0 ],
					"text" : "speedlim 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 582.75, 208.0, 118.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "distanceMetrics.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 731.0, 119.0, 32.5, 19.0 ],
					"text" : "0",
					"varname" : "toggle[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.375, 25.5, 326.0, 62.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 247.25, 140.0, 50.0, 20.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 66.5, 243.0, 54.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 417.75, 186.0, 52.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 332.5, 186.0, 52.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 247.25, 186.0, 52.0, 21.0 ],
					"triscale" : 0.9,
					"varname" : "flonum[7]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.5, 215.0, 97.0, 21.0 ],
					"text" : "groove~ buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.5, 347.5, 50.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 347.5, 50.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 287.0, 370.5, 100.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 444.0, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 611.0, 25.5, 135.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 919.25, 280.0, 919.25, 280.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 592.25, 280.0, 592.25, 280.0 ],
					"source" : [ "obj-194", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 26.0, 361.0, 8.75, 361.0, 8.75, 15.5, 947.5, 15.5 ],
					"source" : [ "obj-209", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 26.0, 361.0, 8.25, 361.0, 8.25, 15.5, 620.5, 15.5 ],
					"source" : [ "obj-209", 0 ]
				}
...
, 			{
				"name" : "distanceMetrics.js",
				"bootpath" : "/Volumes/liferaid/DESKTOP/MIR-experiments/InstrumentRecognition",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
