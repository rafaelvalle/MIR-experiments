...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.5, 398.0, 34.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 172.75, 89.0, 61.0, 21.0 ],
					"text" : "compare",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 161.5, 407.0, 34.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 58.75, 89.0, 39.0, 21.0 ],
					"text" : "learn",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 773.5, 119.0, 34.0, 21.0 ],
					"text" : "play",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 702.5, 566.5, 564.0, 99.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 489.0, 564.0, 99.0 ],
					"setminmax" : [ 0.0, 25.0 ],
					"size" : 25,
					"spacing" : 1,
					"varname" : "a[2]"
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 67.25, 425.0, 51.5, 55.0 ],
					"presentation_rect" : [ 71.0, 422.0, 0.0, 0.0 ]
				}
...
,
					"patching_rect" : [ 54.0, 370.5, 79.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 135.75, 566.5, 564.0, 99.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 253.5, 564.0, 99.0 ],
					"setminmax" : [ 0.0, 10.0 ],
					"size" : 200,
					"spacing" : 1,
					"varname" : "a[3]"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.0, 114.5, 56.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 258.0, 72.5, 56.0, 18.0 ],
					"text" : "getInprof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.0, 140.0, 56.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 258.0, 98.0, 56.0, 18.0 ],
					"text" : "getSprof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 135.75, 450.0, 564.0, 99.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 137.0, 564.0, 99.0 ],
					"setminmax" : [ 0.0, 10.0 ],
					"size" : 200,
					"spacing" : 1,
					"varname" : "a[1]"
...
,
					"patching_rect" : [ 723.75, 136.0, 47.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 832.75, 50.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 723.75, 352.0, 184.0, 75.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 372.5, 564.0, 99.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 2,
					"spacing" : 1,
					"varname" : "a"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 723.75, 255.0, 48.0, 20.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 830.5, 107.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 145.5, 89.0, 20.0, 20.0 ],
					"varname" : "toggle[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 830.5, 136.0, 47.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 779.75, 255.0, 62.0, 20.0 ],
					"varname" : "number[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 830.5, 177.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.75, 177.0, 100.0, 20.0 ],
					"text" : "prepend learn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.0, 183.5, 77.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 323.0, 98.0, 77.0, 18.0 ],
					"text" : "clearSprof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.0, 161.0, 83.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 323.0, 72.5, 83.0, 18.0 ],
					"text" : "clearInprof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 723.75, 107.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 33.0, 89.0, 20.0, 20.0 ],
					"varname" : "toggle[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 751.75, 78.0, 100.0, 20.0 ],
					"text" : "speedlim 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 723.75, 215.0, 118.0, 20.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.5, 27.0, 50.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.0, 27.0, 50.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 378.0, 50.0, 100.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 504.0, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 752.0, 25.5, 135.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 733.25, 280.0, 733.25, 280.0 ],
					"source" : [ "obj-194", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 63.5, 399.5, 664.5, 399.5, 664.5, 15.5, 761.5, 15.5 ],
					"source" : [ "obj-4", 0 ]
				}
