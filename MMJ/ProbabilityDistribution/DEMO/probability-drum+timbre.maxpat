...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 278.0, 841.5, 100.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 278.0, 780.5, 100.0, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 29.25, 643.5, 100.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 29.25, 582.5, 100.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 434.25, 96.530029, 181.0, 50.0 ],
					"text" : "0 1. 16000 1. 10000 0. 16000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1060.0, 7.5, 219.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 10.5, 219.0, 34.0 ],
					"text" : "DRUM IMPROVISOR"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 278.0, 881.0, 135.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 44.5, 135.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 278.0, 904.0, 151.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 879.0, 135.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 42.5, 135.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.75, 615.5, 42.0, 20.0 ],
					"text" : "s ins2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.75, 615.5, 42.0, 20.0 ],
					"text" : "s ins1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 216.0, 67.0, 101.0, 33.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 368.5, 28.5, 101.0, 33.0 ],
									"text" : "HAND B"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 67.0, 100.0, 33.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 33.0, 28.5, 100.0, 33.0 ],
									"text" : "HAND A"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 50.0, 125.5, 100.0, 20.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 242.25, 129.0, 50.0, 20.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 50.0, 100.0, 134.5625, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 242.0, 154.5, 49.0, 20.0 ],
													"text" : "zl nth 1"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 246.0, 103.5, 134.5625, 20.0 ],
													"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
													"varname" : "menu-sd"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 242.0, 234.5, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 20.0, 242.0, 215.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 216.0, 219.5, 32.5, 20.0 ],
									"text" : "- 35"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 20.0, 219.5, 32.5, 20.0 ],
									"text" : "- 35"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 496.5, 74.0, 68.0, 20.0 ],
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 496.5, 16.0, 100.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 496.5, 48.0, 189.0, 20.0 ],
									"text" : "sprintf timbre-interp-prob-%d.json"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 313.0, 48.0, 100.0, 20.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 416.5, 168.0, 59.5, 20.0 ],
									"restore" : 									{
										"timbre-prob-1" : [ 0, 63, 0, 0 ],
										"timbre-prob-2" : [ 79, 21, 10, 0 ]
									}
,
									"text" : "autopattr",
									"varname" : "u525000900"
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 147.5, 130.5, 32.5, 18.0 ],
													"text" : "81"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 115.0, 130.5, 32.5, 18.0 ],
													"text" : "61"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 82.5, 130.5, 32.5, 18.0 ],
													"text" : "60"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 61.25, 208.5, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 216.0, 190.5, 91.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 152.5, 127.0, 32.5, 18.0 ],
													"text" : "49"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 118.5, 127.0, 32.5, 18.0 ],
													"text" : "81"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 83.5, 127.0, 32.5, 18.0 ],
													"text" : "44"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 96.125, 205.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 20.0, 193.0, 135.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 216.0, 102.0, 160.0, 81.0 ],
									"pointcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 33.0, 69.5, 275.0, 74.0 ],
									"range" : 101,
									"size" : 4,
									"table_data" : [ 0, 79, 21, 10, 0 ],
									"varname" : "timbre-prob-2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 20.0, 102.0, 160.0, 81.0 ],
									"pointcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 368.5, 69.5, 275.0, 74.0 ],
									"range" : 101,
									"size" : 4,
									"table_data" : [ 0, 0, 63, 0, 0 ],
									"varname" : "timbre-prob-1"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ -18.0, -46.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 395.0, 102.0, 221.0, 59.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 33.0, 170.0, 221.0, 59.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 313.0, 11.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 404.5, 222.0, 382.75, 222.0, 382.75, 92.0, 455.0, 92.0 ],
									"source" : [ "obj-17", 0 ]
								}
...
,
					"patching_rect" : [ 396.75, 589.5, 113.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 948.25, 88.530029, 113.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 146.5, 886.0, 50.0, 20.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 146.5, 860.0, 32.5, 20.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1308.0, 690.5, 111.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1308.0, 636.0, 32.5, 20.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 96.25, 295.0, 100.0, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.5, 910.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1236.1875, 781.0, 40.0, 20.0 ],
					"text" : "r ins4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1020.187439, 781.0, 40.0, 20.0 ],
					"text" : "r ins3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 871.75, 747.5, 42.0, 20.0 ],
					"text" : "s ins3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 982.21875, 834.5, 40.0, 20.0 ],
					"text" : "r ins2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 944.25, 888.5, 40.0, 20.0 ],
					"text" : "r ins1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 871.75, 647.5, 42.0, 20.0 ],
					"text" : "s ins4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.75, 564.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.25, 107.030029, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.500008, 107.030029, 50.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 871.75, 613.0, 49.0, 20.0 ],
					"text" : "zl nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 871.75, 586.0, 134.5625, 20.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "menu-extra"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 831.0, 472.0, 107.0, 20.0 ],
					"text" : "s drum-machine"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 831.0, 424.0, 69.0, 20.0 ],
					"text" : "r rand-num"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 831.0, 449.0, 200.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 885.0, 266.5, 58.0, 20.0 ],
					"text" : "listfunnel"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1073.0, 182.5, 32.5, 20.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "float" ],
					"patching_rect" : [ 972.5, 182.5, 32.5, 20.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1073.0, 159.5, 59.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1108.5, 176.0, 59.0, 20.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1073.0, 139.5, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1108.5, 156.0, 40.0, 20.0 ],
					"text" : "invert"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 932.75, 139.5, 112.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 992.25, 156.0, 112.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 972.5, 159.5, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 992.25, 176.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 885.0, 224.5, 220.5, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 885.0, 40.5, 247.0, 84.0 ],
					"peakcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 890.0, 203.5, 275.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 895.0, 7.5, 94.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 890.0, 168.5, 94.0, 34.0 ],
					"text" : "FOOT B"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 884.5, 328.5, 160.0, 81.0 ],
					"pointcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 890.0, 278.5, 275.0, 74.0 ],
					"range" : 101,
					"size" : 32,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 871.75, 719.0, 49.0, 20.0 ],
					"text" : "zl nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 871.75, 692.0, 134.5625, 20.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "menu-bd"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.5, 806.5, 113.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 708.25, 49.530029, 98.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.25, 671.0, 100.0, 20.0 ],
					"text" : "prepend /ramp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.25, 550.0, 112.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 434.25, 68.530029, 181.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1263.75, 454.000061, 132.25, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 944.25, 985.5, 45.0, 20.0 ],
					"text" : "s OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 472.0, 107.0, 20.0 ],
					"text" : "s drum-machine"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 472.0, 107.0, 20.0 ],
					"text" : "s drum-machine"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 581.0, 472.0, 107.0, 20.0 ],
					"text" : "s drum-machine"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 424.0, 69.0, 20.0 ],
					"text" : "r rand-num"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 449.0, 190.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 525.5, 176.0, 59.0, 20.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 525.5, 156.0, 40.0, 20.0 ],
					"text" : "invert"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 413.5, 156.0, 112.0, 20.0 ],
					"text" : "compression factor"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 413.5, 176.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.0, 7.5, 94.0, 34.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 602.5, 328.5, 160.0, 81.0 ],
					"pointcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 424.0, 69.0, 20.0 ],
					"text" : "r rand-num"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 449.0, 190.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 817.0, 176.0, 59.0, 20.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 817.0, 156.0, 40.0, 20.0 ],
					"text" : "invert"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 701.25, 156.0, 112.0, 20.0 ],
					"text" : "compression factor"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 701.25, 176.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.0, 7.5, 101.0, 34.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.5, 328.5, 160.0, 81.0 ],
					"pointcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 425.0, 69.0, 20.0 ],
					"text" : "r rand-num"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1322.0, 667.5, 107.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 449.0, 205.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.25, 267.5, 89.0, 20.0 ],
					"text" : "prepend setlist"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 242.25, 173.5, 59.0, 20.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 242.25, 153.5, 40.0, 20.0 ],
					"text" : "invert"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 124.5, 153.5, 112.0, 20.0 ],
					"text" : "compression factor"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 124.5, 173.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 8.5, 101.0, 34.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 34.5, 329.5, 160.0, 81.0 ],
					"pointcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.25, 719.5, 50.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 28.25, 692.0, 100.0, 20.0 ],
					"text" : "rvLine"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.25, 806.5, 84.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.25, 126.030029, 67.0, 20.0 ],
					"text" : "humanizer"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.500008, 126.030029, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"autorestore" : "prob-drums-32timesteps.json",
					"fontname" : "Arial",
					"fontsize" : 9.0,
					"id" : "obj-7",
					"interp" : 					{
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.25, 886.0, 112.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.500008, 87.530029, 50.0, 20.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.25, 87.530029, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1047.5, 76.030029, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1061.25, 88.530029, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "5",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 46.0, 94.530029, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 346.0, 87.530029, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 808.75, 49.530029, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 214.75, 292.0, 20.5, 292.0, 20.5, 33.5, 44.5, 33.5 ],
					"source" : [ "obj-115", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1040.75, 297.0, 870.5, 297.0, 870.5, 32.5, 894.5, 32.5 ],
					"source" : [ "obj-206", 0 ]
				}
